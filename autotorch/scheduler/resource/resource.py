...
class Resources(object):
    """Resource for AutoTorch Scheduler :class:`autotorch.scheduler.TaskScheduler`
...
class DistributedResource(Resources):
    """Resource for AutoTorch Distributed Scheduler :class:`autotorch.distributed.DistributedTaskScheduler`
