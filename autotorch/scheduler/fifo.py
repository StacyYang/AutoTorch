...
class FIFOScheduler(TaskScheduler):
    ...
    ----------
    train_fn : callable
        A task launch function for training. Note: please add the `@autotorch_method` decorater to the original function.
    ...
    searcher : str or object
        Autotorch searcher. For example, autotorch.searcher.self.argsRandomSampling
    time_attr : str
    ...
    def get_training_curves(self, filename=None, plot=False, use_legend=True):
        ...
        >>> scheduler.get_training_curves(plot=True)
            ...
            .. image:: https://github.com/zhanghang1989/AutoTorchWebdata/blob/master/doc/api/autotorch.1.png?raw=true
        """
