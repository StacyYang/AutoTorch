...
from ..utils import AutoTorchWarning, AutoTorchEarlyStop, CustomProcess
...
class TaskScheduler(object):
    ...
    def shutdown(self):
        """shutdown() is now deprecated in favor of :func:`autotorch.done`.
        """
        warn("scheduler.shutdown() is now deprecated in favor of autotorch.done().",
             AutoTorchWarning)
        self.join_jobs()
