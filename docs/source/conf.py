...
# -*- coding: utf-8 -*-
#
# AutoTorch documentation build configuration file, created by
...
version = 'master (' + autotorch.__version__ + ')'
...
htmlhelp_basename = 'AutoTorchdoc'
...
latex_documents = [
    (master_doc, 'autotorch.tex', 'AutoTorch Documentation',
     'Stacy Yang', 'manual'),
]
...
man_pages = [
    (master_doc, 'AutoTorch', 'AutoTorch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AutoTorch', 'AutoTorch Documentation',
     author, 'AutoTorch', 'One line description of project.',
     'Miscellaneous'),
]
